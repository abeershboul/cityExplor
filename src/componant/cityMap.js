...
getMovieData = async (data) => {
  const Movie_URL = `https://api.themoviedb.org/3/movie/550?api_key=f032efe3d7f534647b671082a4a1540f?cityName=${data}`;
  try
  {
  ...
  render(){
    ...
    return(
      <div class="text-center">
          ...
          {this.state.mapFlag && <img class="rounded" alt ="Map" src={`https://maps.locationiq.com/v3/staticmap?key=pk.8814dece528e9fd34555ea0a15dbe211&center=${this.state.lat},${this.state.lon}`}></img>}
